...
class CourseDepartments:
    ...
    def __build_abbr_map(self):
        ...
        outer_table: bs4.element.Tag = soup.find_all("table", class_="table_default")[
            -1
        ]  # type: ignore
        inner_table: bs4.element.Tag = outer_table.find("table")  # type: ignore

        abbr_map = {}
        row: bs4.element.Tag
        for row in inner_table.find_all("tr"):  # type: ignore
